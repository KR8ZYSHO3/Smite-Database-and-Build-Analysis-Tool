...
FLEX_ITEM_GUIDE: dict[str, dict[str, Any]] = {
    ...
    "Stygian Anchor": {
        "tags": ["answer", "shred"],
        "roles": ["Support", "Solo"],
        "simple": "Your damage cuts enemy healing (antiheal) and slows their attack speed in stacks.",
    ...
    "Brawler's Beat Stick": {
        ...
        "simple": "Hitting gods applies healing reduction + you stack combat stats.",
    ...
    "Divine Ruin": {
        "tags": ["answer", "shred"],
        "roles": ["Mid"],
        "simple": "Mage anti-heal: your god damage cuts healing + lightning proc.",
    ...
    "Lotus Sickle": {
        ...
        "how": "You’re charging free damage onto your ADC’s autos. Needs an ally who actually basics (Carry). Same trigger as Soul Locket — they stack together. Passiveive — no button. Do not buy/sell to stack stats (exploit; suspensions).",
        ...
        "buy_as": "Support 2nd after Thebes (cheap CDR + Int). Live in shop OB43.",
        "featured": True,
        "patch": "OB43",
    },
    "Soul Locket": {
    ...
    "Chandra's Grace": {
        "tags": ["aura", "sustain"],
        "roles": ["Support"],
        "simple": "+15% heal/shield strength (OB43 hotfix). Every 15s, lowest-HP nearby ally gets regen and tiny cooldown shred.",
        "how": "Aura amp for healers plus a periodic “help the dying ally” buff. Hotfix cut amp 20→15% — still fine on true healers, not a generic Solo shell.",
        "when": "Support heal/amp paths after Thebes / Sickle / Asclepius.",
        "when_not": "You’re full damage with no heals; non-healer Solo looking for free aura.",
        "buy_as": "Support heal flex after core enchanter items. Remade OB43; hotfix 9/9.",
        "featured": True,
        "patch": "OB43",
    },
    "Barbed Carver": {
        "tags": ["concept", "sustain"],
        "roles": ["Jungle", "Solo", "Carry"],
        "simple": "Ability hits apply Jagged Wounds (max 3). Basics and abilities deal bonus physical damage per stack (scales with your lifesteal).",
        "how": "Cast to stack wounds, then auto/ability for bonus damage. Replaced Serrated Edge (old name still ghosts on trackers/wiki).",
        "when": "Physical ability junglers/bruisers who also basic-attack in the combo.",
        "when_not": "Pure mage INT kits; you never land abilities.",
        "buy_as": "Jungle 1st–3rd on ability-physical kits. Live shop name — not Serrated Edge.",
        "featured": True,
        "patch": "OB15+",
    },
    "Umbral Link": {
    ...
    "Contagion": {
        ...
        "when_not": "You need antiheal (buy Stygian/Brawler’s/Divine or Sundering 40%); you’re mid glass.",
    ...
    "Heartwood Charm": {
        "tags": ["concept", "active", "sustain"],
        "roles": ["Support", "Mid"],
        "simple": "+10% heal/shield strength (OB43 hotfix; was 20%). Heals you cast store a bank; active dumps that heal to nearby allies.",
        "how": "Spam heals to fill the bank → press active for a team heal bomb. Hotfix removed heal-ability CDR and cut amp — prefer Asclepius + Sickle first; Heartwood is flex if you still want the active.",
        "when": "Healer supports who specifically want the bank dump and have an active slot free.",
        "when_not": "No heal abilities; you already have Soul Locket; prefer button-light paths.",
        "buy_as": "Healer flex after Sickle/Asclepius — not default dual-active. Remade OB43; hotfix 9/9.",
        "featured": True,
        "patch": "OB43",
    },
    "Daybreak Gavel": {
