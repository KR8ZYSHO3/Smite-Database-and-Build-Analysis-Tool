...
Danzaburou · Carry · archetype «crit_adc» (STR / physical). Kit effects: channel / cast time, big ult spike, basic-attack kit, hard crowd control, CC immunity in kit, lots of CC. Tags: aa, anti_cc, burst, channel, dot, hard_cc, heal, high_cc. Style burst 70%/dps 30%; patch new (net +0.1, r5 +0.0). Patch axes (r5): general +0.0. Scale STR 113% / INT 119%. Path: Odysseus' Bow (Carry path fit for kit profile); Tyrfing (Carry path fit for kit profile); Eye of the Storm (Carry path fit for kit profile). Pen: Titan's Bane, Riptalon. Actives 0/2 · pen ≈ 30. Soft high-SR inspiration on 4 item(s) (tracker.gg — not a meta copy).
