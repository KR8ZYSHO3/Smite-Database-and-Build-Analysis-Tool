...
Cupid · Carry · archetype «crit_adc» (STR / physical). Kit effects: big ult spike, attack-speed steroid, heavy healing, pet / deployable, hard crowd control, dash / leap engage. Tags: as_steroid, gap_close, hard_cc, heal, heavy_heal, long_cd, pet_zone, sustained. Style burst 43%/dps 57%; patch stable (net +0.9, r5 +0.0). Patch axes (r5): damage +0.9, attack_speed +0.1, general -0.0. Scale STR 117% / INT 84%. Path: Transcendence (mana stack → power scaling); Tyrfing (Carry path fit for kit profile); Bloodforge (lifesteal + power for execute/bruiser). Pen: Transcendence, Riptalon, Titan's Bane. Actives 1/2 · pen ≈ 30. Soft high-SR inspiration on 4 item(s) (tracker.gg — not a meta copy).
